                  ...
                  <form onChange={this.handleChangeForm} onSubmit={this.captureOrder}>
                    ...
                    <div className="mb-5">
                        ...
                        <div className="col-12 mb-3">
                          <label className="w-100">
                            ...
                            <Dropdown
                              ...
                              placeholder="Elige un metodo de envio"
                            >
                              {
                      ...
                      >
                        ...
                        />
                        <p>
                          Recibe noticias, productos nuevos, promociones y descuentos en tu correo!
                          No te llenaremos de spam, solo buenas noticias 😯🙂
                        </p>
                      </div>
                    ...
                    <p className="checkout-error">
                      { !selectedShippingOption ? 'Elije una opcion de envio!' : '' }
                    </p>
                    <button
                      type="submit"
              ...
              <div className="bg-brand200 p-lg-5 p-3 checkout-summary">
                ...
                <div className="row py-3 borderbottom border-color-gray400">
                  <input
                    ...
                    placeholder="Tarjeta de regalo o codigo de descuento"
                    className="mr-2 col"
                  />
                  <button
