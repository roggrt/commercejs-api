          ...
          <div ref={this.exploreContainer} className="custom-container py-md-5">
            <div className="row py-5">
              <div className="col-12 col-md-6 py-5">
                ...
                >
                  Una nueva experiencia de compra, los mejores precios de productos electronicos como tv, camaras, celulares, laptops y mas lo encuentras aqui 😎🤑😌😳
                </p>
                <div className="d-flex">
                  <Link href="/collection">
                    <a className="d-flex py-3 align-items-center font-color-black borderbottom border-color-black">
                      <p className="mr-3">Revisar los productos disponibles</p>
